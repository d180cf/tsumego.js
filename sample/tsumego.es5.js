...
(function (tsumego) {
    ...
    function region(root, belongs) {
        var body, edge, xy, nxy, t$2$0, t$2$1;
        return regeneratorRuntime.wrap(function region$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                ...
                case 6:
                    ...
                    for (t$2$0 = regeneratorRuntime.values(tsumego.stone.neighbors(xy)); !(t$2$1 = t$2$0.next()).done;) {
                        nxy = t$2$1.value;
...
(function (tsumego) {
    ...
    (function (solve_1) {
        ...
        function start(args) {
            var marked3$0, _ref, board, color, _ref$nkt, nkt, _ref$tt, tt, expand, status, alive, stats, debug, sa, path, tags, solve, moves, move, t$3$0, t$3$1;

            return regeneratorRuntime.wrap(function start$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    case 0:
                        solve = function solve(color, nkt) {
                            var depth, prevb, hashb, ttres, result, mindepth, nodes, move, t$4$0, t$4$1, hash, d, r, t$4$2, t$4$3, s, h, i;
                            return regeneratorRuntime.wrap(function solve$(context$4$0) {
                                while (1) switch (context$4$0.prev = context$4$0.next) {
                                    ...
                                    case 9:
                                        ...
                                        context$4$0.next = 14;
                                        return 'reusing cached solution: ' + tsumego.stone.toString(ttres);

                                    case 14:
                                        return context$4$0.abrupt('return', repd.set(ttres, infty));

                                    case 15:
                                        mindepth = infty;
                                        nodes = sa.reset();
                                        t$4$0 = regeneratorRuntime.values(expand(board, color));

                                    case 18:
                                        if ((t$4$1 = t$4$0.next()).done) {
                                            context$4$0.next = 34;
                                            break;
                                        }
                                    ...
                                    case 30:
                                        r = tt.get(hash, -color, d <= depth ? nkt - color : nkt);
                                    ...
                                    case 34:
                                        ...
                                        t$4$2 = regeneratorRuntime.values(nodes);

                                    case 36:
                                        if ((t$4$3 = t$4$2.next()).done) {
                                            context$4$0.next = 97;
                                            break;
                                        }

                                        move = t$4$3.value;
                                        d = !move ? infty : repd.get(move);
                                        h = tsumego.gf32.mul(prevb != hashb ? prevb : 0, 0x87654321) ^ hashb;
                                        ...
                                        context$4$0.next = 48;
                                        return 'yielding the turn to the opponent';

                                    case 48:
                                        i = tags.lastIndexOf(tags[depth], -2);
                                    ...
                                    case 53:
                                        return context$4$0.delegateYield(solve(-color, nkt), 't3', 54);
                                    ...
                                    case 62:
                                        ...
                                        context$4$0.t5 = repd.set(tsumego.stone.nocoords(+1), infty);
                                        context$4$0.next = 83;
                                        break;

                                    case 66:
                                        if (!(color < 0 && alive && alive(board))) {
                                            context$4$0.next = 70;
                                            break;
                                        }

                                        context$4$0.t6 = repd.set(tsumego.stone.nocoords(-1), infty);
                                        context$4$0.next = 82;
                                        break;
                                    ...
                                    case 70:
                                        ...
                                        return context$4$0.delegateYield(solve(-color, nkt), 't8', 72);
                                    ...
                                    case 75:
                                        ...
                                        context$4$0.next = 79;
                                        return 'spending a ko treat';

                                    case 79:
                                        return context$4$0.delegateYield(solve(-color, nkt - color), 't10', 80);

                                    case 80:
                                        context$4$0.t7 = context$4$0.t10;

                                    case 81:
                                        context$4$0.t6 = context$4$0.t7;

                                    case 82:
                                        context$4$0.t5 = context$4$0.t6;
                                    ...
                                    case 85:
                                        ...
                                        context$4$0.next = 89;
                                        return 'the outcome of this move: ' + tsumego.stone.toString(s);
                                    ...
                                    case 89:
                                        ...
                                        return context$4$0.abrupt('break', 97);
                        ...
                        _ref = typeof args === 'string' ? parse(args) : args;
                        board = _ref.root;
                        color = _ref.color;
                        _ref$nkt = _ref.nkt;
                        nkt = _ref$nkt === undefined ? 0 : _ref$nkt;
                        _ref$tt = _ref.tt;
                        tt = _ref$tt === undefined ? new tsumego.TT() : _ref$tt;
                        expand = _ref.expand;
                        status = _ref.status;
                        alive = _ref.alive;
                        stats = _ref.stats;
                        ...
                        for (t$3$0 = regeneratorRuntime.values(moves); !(t$3$1 = t$3$0.next()).done;) {
                            move = t$3$1.value;
                        ...
                        return context$3$0.delegateYield(solve(color, nkt), 't0', 22);
...
//# sourceMappingURL=sample\tsumego.es5.js.map
// first consider moves that lead to a winning position
// path[i] = hash of the i-th position
// tags[i] = hash of the path to the i-th position
